...
#
# nanoprocessor.tcl: Tcl script for re-creating project 'nanoprocessor'
#
# Generated by Vivado on Fri Jul 06 11:56:41 -0700 2018
...
#
# 1. This project restoration tcl script (nanoprocessor.tcl) that was generated.
#
...
#
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/registers.v"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/output_bit.v"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/inout_bit.v"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/clock_sync.v"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/nanoprocessor.v"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/new/3455A.coe"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/constrs_1/new/foo.xdc"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/constrs_1/new/timing.xdc"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sim_1/new/nanoprocessor_test.v"
#    "C:/Projects/nanoprocessor/nanoprocessor_test_behav.wcfg"
#    "C:/Projects/nanoprocessor/nanoprocessor.srcs/sim_1/new/ROM.txt"
#
#*****************************************************************************************
...
set _xil_proj_name_ "nanoprocessor"
...
set script_file "nanoprocessor.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/nanoprocessor"]"
...
set files [list \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/registers.v"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/output_bit.v"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/inout_bit.v"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/clock_sync.v"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/nanoprocessor.v"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/new/3455A.coe"] \
]
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/nanoprocessor.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/nanoprocessor.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/nanoprocessor.srcs/constrs_1/new/foo.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/nanoprocessor.srcs/constrs_1/new/foo.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/nanoprocessor.srcs/constrs_1/new/timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/nanoprocessor.srcs/constrs_1/new/timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/nanoprocessor.srcs/constrs_1/new/foo.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a35ticsg324-1L" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/nanoprocessor.srcs/constrs_1/new/foo.xdc"]" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sim_1/new/nanoprocessor_test.v"] \
 [file normalize "${origin_dir}/nanoprocessor_test_behav.wcfg"] \
 [file normalize "${origin_dir}/nanoprocessor.srcs/sim_1/new/ROM.txt"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/nanoprocessor.srcs/sim_1/new/ROM.txt"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "nanoprocessor_test" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "xsim.simulate.runtime" -value "10000ns" -objects $obj

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35ticsg324-1L -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35ticsg324-1L -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7a35ticsg324-1L -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
